...
You look through the porthole and see a man dressed as an astronaut in the airlock, with Ramirez' nametag. You open comms, and he says he's Ramirez, coming back from the maintenance run. But Ramirez is sitting behind you, telling you not to open the door.
...
The gun is there to fight off bears if you land in the tundra. It's inside a locked box underneath the seat. You pull it out and with trembling hands begin to undo the clasps. Suddenly, a heavy arm knocks into you and pushes you to the ground. Groggily, you notice Ramirez picking up the box and dashing away into the command module.
...
You've been dancing like this now for ever. One kills the other. One kills himself. One pushes the other out of the airlock in shame and guilt, and one comes back from the outside, returning from the dead. You've long since gone insane, but you can't seem to stop the loop. One part inevitably follows the next, like an endless dance, and it always begins with the knock. How do you break such a loop? How do you stop the horror? Your eyes glaze over, as they scan the possibility space. Is there some jump left unexplored? Some pathway...?
...
You check the air pressure and then open the airlock door, a taste of blood in your mouth. The door opens and you step back as 'Ramirez' steps through. He asks you to open his helmet clasps, and you comply, seeing only the reflective black surface of the faceplate until, with a hiss, the helmet's seal is broken and Ramirez removes it.
...
When you wake up, you're confused. The space suit around you feels clammy, like it's filled with liquid. You can barely see anything through your faceplate. Did something go wrong with the maintenance? At least you made it inside the airlock. You call out in your comms, but they aren't working. There's the door. They'll hear you if you knock. Man, what a headache...
